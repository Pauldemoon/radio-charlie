...
for (const key of ["AI_PROVIDER", "GEMINI_API_KEY", "GEMINI_MODEL", "GEMINI_THINKING_LEVEL", "GEMINI_THINKING_BUDGET", "TAVILY_API_KEY", "TAVILY_ENABLED", "TAVILY_SEARCH_DEPTH", "TAVILY_MAX_RESULTS", "VOICE_PROVIDER", "ELEVENLABS_API_KEY", "ELEVENLABS_VOICE_ID", "ELEVENLABS_MODEL", "ELEVENLABS_SPEED", "ELEVENLABS_TIMEOUT_MS", "ELEVENLABS_MAX_CHARS", "RADIO_CHARLIE_FREE_MODE", "RADIO_CHARLIE_STRICT_AI", "RADIO_CHARLIE_STRICT_WEB"]) {
